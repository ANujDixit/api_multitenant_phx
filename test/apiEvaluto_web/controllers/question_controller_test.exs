defmodule ApiEvalutoWeb.QuestionControllerTest do
  use ApiEvalutoWeb.ConnCase

  alias ApiEvaluto.Library
  alias ApiEvaluto.Library.Question

  @create_attrs %{explanation: "some explanation", title: "some title", type: 42}
  ...
  def fixture(:question) do
    {:ok, question} = Library.create_question(@create_attrs)
    question
  end
